...
INDICATOR_POLICY_CLASS: dict[str, dict[str, str]] = {
    ...
    "fred_hy_spread": {"class": "structural", "label": "高收益债利差",
                       "why": "高收益债利差直接反映低评级企业再融资和违约风险溢价"},
    "fred_bbb_spread": {"class": "structural", "label": "BBB信用利差",
                        "why": "BBB利差直接反映投资级边缘企业的降级和融资压力"},
    "fred_ic_spread": {"class": "structural", "label": "AAA企业融资成本",
                       "why": "高质量企业融资成本上升代表无风险利率之外的信用融资压力"},
