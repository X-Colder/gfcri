...
CORE_NODES: dict[str, CausalNode] = {
    ...
    "cn_social_finance_yoy": CausalNode(
        node_id="cn_social_finance_yoy",
        display_name="China Social Financing YoY",
        description="China aggregate social financing year-over-year growth; credit impulse and financing supply proxy.",
        node_type=NodeType.OBSERVABLE,
        asset_class=AssetClass.CREDIT,
        geography="CN",
        data_source="AKShare / China macro",
        update_frequency="monthly",
        unit="%",
    ),
    "cn_m1_yoy": CausalNode(
        node_id="cn_m1_yoy",
        display_name="China M1 Money Supply YoY",
        description="China M1 year-over-year growth; corporate cash-flow and credit-cycle proxy.",
        node_type=NodeType.OBSERVABLE,
        asset_class=AssetClass.CREDIT,
        geography="CN",
        data_source="AKShare / China macro",
    ...
    "cn_lpr_1y": CausalNode(
        node_id="cn_lpr_1y",
        display_name="China 1Y LPR",
        description="China one-year loan prime rate; benchmark financing-cost proxy.",
        node_type=NodeType.OBSERVABLE,
        asset_class=AssetClass.RATES,
        geography="CN",
        data_source="AKShare / China macro",
