...
CORE_NODES: dict[str, CausalNode] = {
    ...
    "global_liqd": CausalNode(
        node_id="global_liqd",
        display_name="Global Liquidity Index",
        description="Composite measure of central-bank balance sheets and credit impulse.",
        node_type=NodeType.LATENT,
        asset_class=AssetClass.MACRO,
        geography="GLOBAL",
        data_source="CrossBorder Capital / BIS",
    ...
    "us_recession_prob": CausalNode(
        ...
        description="Model-implied 12-month US recession probability (NY Fed yield-curve model).",
        node_type=NodeType.LATENT,
        asset_class=AssetClass.MACRO,
        geography="US",
        data_source="NY Fed",
    ...
    "kr_cds_5y": CausalNode(
        node_id="kr_cds_5y",
        display_name="Korea Sovereign CDS 5Y",
        description="5-year South Korea sovereign credit default swap spread.",
        node_type=NodeType.OBSERVABLE,
    ...
    "kr_ca": CausalNode(
        node_id="kr_ca",
        display_name="Korea Current Account Balance",
        description="South Korea monthly current account balance (USD billions).",
        node_type=NodeType.OBSERVABLE,
        asset_class=AssetClass.MACRO,
        geography="KR",
    ...
    "dram_spot": CausalNode(
        node_id="dram_spot",
        display_name="DRAM Spot Price",
        description="Spot price for DDR4 8Gb DRAM chips (USD per unit).",
        node_type=NodeType.OBSERVABLE,
    ...
    "nand_spot": CausalNode(
        node_id="nand_spot",
        display_name="NAND Flash Spot Price",
        description="Spot price for 128Gb TLC NAND flash chips (USD per unit).",
        node_type=NodeType.OBSERVABLE,
        asset_class=AssetClass.COMMODITY,
        geography="GLOBAL",
        data_source="DRAMeXchange",
    ...
    "ai_capex": CausalNode(
        node_id="ai_capex",
        display_name="AI Data-Center Capex",
        description="Aggregated quarterly capex guidance from hyperscalers for AI infrastructure.",
        node_type=NodeType.OBSERVABLE,
        asset_class=AssetClass.MACRO,
        geography="US",
