...
NODE_DATA_OVERRIDES: dict[str, dict[str, Any]] = {
    ...
    "cn_social_finance_yoy": {
        "source_tier": "A",
        "raw_formula": "AKShare China new financial credit latest year-over-year growth field.",
        "stress_direction": "lower_is_credit_impulse_deterioration",
        "absolute_threshold": "normal=10.0, crisis=-10.0",
        "known_limitations": "Monthly China macro release; revisions and AKShare schema changes can affect availability.",
        "upgrade_plan": "Add official PBOC TSF stock/flow series, credit impulse, property bond spreads, and LGFV stress data.",
    },
    "cn_m1_yoy": {
        "source_tier": "A",
        "raw_formula": "AKShare China money supply latest M1 year-over-year growth field.",
        "stress_direction": "lower_is_corporate_cashflow_credit_stress",
        "absolute_threshold": "normal=5.0, crisis=-5.0",
        "known_limitations": "M1 growth is macro liquidity, not direct default risk; it can lag market credit stress.",
        "upgrade_plan": "Add corporate deposit growth, private credit demand, and invoice/receivable stress proxies.",
    },
    "cn_lpr_1y": {
        "source_tier": "A",
        "raw_formula": "AKShare China LPR latest 1Y loan prime rate.",
        "stress_direction": "higher_is_financing_cost_pressure",
        "absolute_threshold": "normal=3.0, crisis=5.0",
        "known_limitations": "Policy benchmark rate can be administratively controlled and may not represent private credit availability.",
        "upgrade_plan": "Add actual lending rates, credit spreads, property bond yields, and bank loan officer surveys if available.",
    },
    "hyg": {
        "source_tier": "B",
