...
CREATE INDEX IF NOT EXISTS idx_institutional_observations_tenant_date
    ON institutional_observations (tenant_id, as_of DESC);

CREATE INDEX IF NOT EXISTS idx_institutional_observations_entity
    ON institutional_observations (tenant_id, entity_type, entity_id);
