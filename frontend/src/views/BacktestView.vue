...
const DAMAGE_PROFILES: Record<string, DamageProfile> = {
  ...
  '2022 暴力加息': {
    ...
    label: '市场调整',
    labelEn: 'Market Correction',
    summary: '损害主要集中在股债估值、美元融资和利率敏感金融机构；股债跌幅很深，但美国实体经济没有出现 2008 或 2020 级别的同步崩塌。',
    summaryEn: 'Damage was concentrated in equity/bond valuation, dollar funding, and rate-sensitive financial institutions. Market losses were deep, but the US real economy did not experience a 2008- or 2020-level synchronized collapse.',
    metrics: [
      { label: '股债损害', labelEn: 'Equity/Bond Damage', value: 'S&P 500 从 2022 年 1 月高点约 4,797 跌至 10 月低点约 3,577，回撤约 25%；Nasdaq Composite 从高点回撤约 35%；TLT 等长久期美债 ETF 年内跌幅约 30%。', valueEn: 'The S&P 500 fell from about 4,797 in January 2022 to about 3,577 in October, a roughly 25% drawdown. The Nasdaq Composite fell about 35% from its high. Long-duration Treasury ETFs such as TLT fell roughly 30% during the year.' },
      { label: '汇率损害', labelEn: 'FX Damage', value: 'DXY 从年初约 95-96 升至 9 月约 114-115，涨幅约 20%；美元兑日元一度接近 150，英镑兑美元一度跌至约 1.03。', valueEn: 'DXY rose from roughly 95-96 at the start of 2022 to about 114-115 in September, around a 20% move. USD/JPY neared 150 and GBP/USD briefly fell to about 1.03.' },
      { label: '利率损害', labelEn: 'Rate Damage', value: '美国 10 年期国债收益率从约 1.5% 升至约 4.2%；30 年抵押贷款利率从约 3.1% 升至约 7% 以上，房地产和久期资产估值承压。', valueEn: 'The US 10-year Treasury yield rose from about 1.5% to roughly 4.2%. The 30-year mortgage rate rose from about 3.1% to above 7%, pressuring housing and long-duration valuations.' },
      { label: '金融损害', labelEn: 'Financial Damage', value: '英国 LDI/养老金危机迫使英国央行临时购买长期国债；2023 年 SVB 倒闭，资产规模约 2,090 亿美元，是美国历史上较大的银行倒闭之一，暴露未实现债券亏损和存款外流风险。', valueEn: 'The UK LDI/pension crisis forced the Bank of England to temporarily buy long gilts. In 2023, SVB failed with about $209bn in assets, one of the largest US bank failures, exposing unrealized bond losses and deposit-flight risk.' },
      { label: '实体经济损害', labelEn: 'Real-Economy Damage', value: '美国没有出现 2008 式信用冻结或 2020 式就业崩塌；失业率大多维持在约 3.5%-4% 区间，因此定级为 D1 而非 D3/D4。', valueEn: 'The US did not experience a 2008-style credit freeze or 2020-style labor-market collapse. Unemployment mostly stayed around 3.5%-4%, so the damage level is D1 rather than D3/D4.' },
    ],
  },
}
